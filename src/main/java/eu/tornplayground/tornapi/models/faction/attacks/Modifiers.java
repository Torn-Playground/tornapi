...
public class Modifiers extends Model {
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(fairFight, modifiers.fairFight) == 0 && Float.compare(war, modifiers.war) == 0 && Float.compare(retaliation, modifiers.retaliation) == 0 && Float.compare(groupAttack, modifiers.groupAttack) == 0 && Float.compare(overseas, modifiers.overseas) == 0 && Float.compare(chainBonus, modifiers.chainBonus) == 0;
    }
