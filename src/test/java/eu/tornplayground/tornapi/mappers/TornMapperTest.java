...
class TornMapperTest {
    ...
    void ofCompanies() throws IOException {
        ...
        JsonNode json = objectMapper.readTree(this.getClass().getResource("/responses/torn-companies.json").openStream());
    ...
    void ofItems() throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        JsonNode json = objectMapper.readTree(this.getClass().getResource("/responses/torn-items.json").openStream());
