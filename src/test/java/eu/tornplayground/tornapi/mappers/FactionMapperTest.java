...
class FactionMapperTest {
    ...
    void ofAttacks() {
        ...
        softly.assertThat(result.getFirst().getCode()).isEqualTo("abc122");
        softly.assertThat(result.getFirst().getTimestampStarted()).isEqualTo(Instant.ofEpochSecond(1729886519).atZone(ZoneOffset.UTC).toLocalDateTime());
        softly.assertThat(result.getFirst().getTimestampEnded()).isEqualTo(Instant.ofEpochSecond(1729886521).atZone(ZoneOffset.UTC).toLocalDateTime());
        softly.assertThat(result.getFirst().getAttackerId()).isEqualTo(1);
        softly.assertThat(result.getFirst().getAttackerName()).isEqualTo("Player One");
        softly.assertThat(result.getFirst().getAttackerFaction()).isEqualTo(1);
        softly.assertThat(result.getFirst().getAttackerFactionName()).isEqualTo("Faction One");
        softly.assertThat(result.getFirst().getDefenderId()).isEqualTo(2);
        softly.assertThat(result.getFirst().getDefenderName()).isEqualTo("Player Two");
        softly.assertThat(result.getFirst().getDefenderFaction()).isEqualTo(2);
        softly.assertThat(result.getFirst().getDefenderFactionName()).isEqualTo("Faction Two");
        softly.assertThat(result.getFirst().getResult()).isEqualTo(AttackResult.ATTACKED);
        softly.assertThat(result.getFirst().isStealthed()).isEqualTo(true);
        softly.assertThat(result.getFirst().getRespect()).isEqualTo(4.68f);
        softly.assertThat(result.getFirst().getChain()).isEqualTo(1340);
        softly.assertThat(result.getFirst().isRaid()).isEqualTo(false);
        softly.assertThat(result.getFirst().isRankedWar()).isEqualTo(false);
        softly.assertThat(result.getFirst().getRespectGain()).isEqualTo(4.68f);
        softly.assertThat(result.getFirst().getRespectLoss()).isEqualTo(1.17f);
        softly.assertThat(result.getFirst().getModifiers().getFairFight()).isEqualTo(3f);
        softly.assertThat(result.getFirst().getModifiers().getWar()).isEqualTo(1f);
        softly.assertThat(result.getFirst().getModifiers().getRetaliation()).isEqualTo(1f);
        softly.assertThat(result.getFirst().getModifiers().getGroupAttack()).isEqualTo(1f);
        softly.assertThat(result.getFirst().getModifiers().getOverseas()).isEqualTo(1f);
        softly.assertThat(result.getFirst().getModifiers().getChainBonus()).isEqualTo(1.53f);
 ...
 "attacks": {"1": {"code": "abc122","timestamp_started": 1729886519,"timestamp_ended": 1729886521,"attacker_id": 1,"attacker_name": "Player One","attacker_faction": 1,"attacker_factionname": "Faction One","defender_id": 2,"defender_name": "Player Two","defender_faction": 2,"defender_factionname": "Faction Two","result": "Attacked","stealthed": 1,"respect": 4.68,"chain": 1340,"raid": 0,"ranked_war": 0,"respect_gain": 4.68,"respect_loss": 1.17"modifiers": {"fair_fight": 3,"war": 1,"retaliation": 1,"group_attack": 1,"overseas": 1,"chain_bonus": 1.53}}"2": {"code": "abc123","timestamp_started": 1729886531,"timestamp_ended": 1729886534,"attacker_id": 2,"attacker_name": "Player Two","attacker_faction": 2,"attacker_factionname": "Faction Two","defender_id": 1,"defender_name": "Player One","defender_faction": 1,"defender_factionname": "Faction One","result": "Attacked","stealthed": 1,"respect": 3.76,"chain": 1341,"raid": 0,"ranked_war": 0,"respect_gain": 3.76,"respect_loss": 0.94"modifiers": {"fair_fight": 2.08,"war": 1,"retaliation": 1,"group_attack": 1,"overseas": 1,"chain_bonus": 1.53}}}}
    ...
    void ofBasic() {
        ...
        softly.assertThat(basic.getRaidWars().getFirst().getRaidingFaction()).isEqualTo(51606);
        softly.assertThat(basic.getRaidWars().getFirst().getDefendingFaction()).isEqualTo(51260);
        softly.assertThat(basic.getRaidWars().getFirst().getRaiderScore()).isEqualTo(4168.87f);
        softly.assertThat(basic.getRaidWars().getFirst().getDefenderScore()).isEqualTo(0);
        softly.assertThat(basic.getRaidWars().getFirst().getStartTime()).isEqualTo(Instant.ofEpochSecond(1723608429).atZone(ZoneOffset.UTC).toLocalDateTime());

        softly.assertThat(basic.getTerritoryWars().size()).isEqualTo(2);
        softly.assertThat(basic.getTerritoryWars().getFirst().getTerritoryWarId()).isEqualTo(42201);
        softly.assertThat(basic.getTerritoryWars().getFirst().getTerritory()).isEqualTo("EJE");
        softly.assertThat(basic.getTerritoryWars().getFirst().getAssaultingFaction()).isEqualTo(9055);
        softly.assertThat(basic.getTerritoryWars().getFirst().getDefendingFaction()).isEqualTo(11581);
        softly.assertThat(basic.getTerritoryWars().getFirst().getScore()).isEqualTo(0);
        softly.assertThat(basic.getTerritoryWars().getFirst().getRequiredScore()).isEqualTo(1250000);
        softly.assertThat(basic.getTerritoryWars().getFirst().getStartTime()).isEqualTo(Instant.ofEpochSecond(1729869786).atZone(ZoneOffset.UTC).toLocalDateTime());
        softly.assertThat(basic.getTerritoryWars().getFirst().getEndTime()).isEqualTo(Instant.ofEpochSecond(1730128986).atZone(ZoneOffset.UTC).toLocalDateTime());
        softly.assertThat(basic.getTerritoryWars().getFirst().getAssaulters().size()).isEqualTo(5);
        softly.assertThat(basic.getTerritoryWars().getFirst().getDefenders().size()).isEqualTo(13);
    ...
    void ofRankedWar() {
        ...
        softly.assertThat(rankedWar.getFirst().getFactions().size()).isEqualTo(2);
        softly.assertThat(rankedWar.getFirst().getFactions().get(1).getName()).isEqualTo("Faction One");
        softly.assertThat(rankedWar.getFirst().getFactions().get(1).getScore()).isEqualTo(7781);
        softly.assertThat(rankedWar.getFirst().getFactions().get(1).getChain()).isEqualTo(744);
        softly.assertThat(rankedWar.getFirst().getFactions().get(2).getName()).isEqualTo("Faction Two");
        softly.assertThat(rankedWar.getFirst().getFactions().get(2).getScore()).isEqualTo(2385);
        softly.assertThat(rankedWar.getFirst().getFactions().get(2).getChain()).isEqualTo(1384);
        softly.assertThat(rankedWar.getFirst().getWar().getStart()).isEqualTo(Instant.ofEpochSecond(1647730800).atZone(ZoneOffset.UTC).toLocalDateTime());
        softly.assertThat(rankedWar.getFirst().getWar().getEnd()).isEqualTo(Instant.ofEpochSecond(1647822076).atZone(ZoneOffset.UTC).toLocalDateTime());
        softly.assertThat(rankedWar.getFirst().getWar().getTarget()).isEqualTo(5390);
        softly.assertThat(rankedWar.getFirst().getWar().getWinner()).isEqualTo(45835);
        softly.assertAll();
    }
